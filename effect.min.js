...
!function(t) {
    ...
    var u, l, f, d, t, p, h, g, i, e, b, a, o, c, m, y, n, r, v, x, C = "ui-effects-", w = s;
    function _(t, e, n) {
        var r = g[e.type] || {};
    ...
    function k(r) {
        ...
        a.length ? ("0,0,0,0" === a.join() && u.extend(a, f.transparent),
        o) : f[r]
    }
    function M(t, e, n) {
    ...
    function j(t, e, n, r) {
        ...
        n = null,
        e = {}),
        "number" != typeof e && !s.fx.speeds[e] || (r = n,
        n = e,
        e = {}),
        s.isFunction(n) && (r = n,
        n = null),
 ...
 */
    ...
    p.fn = u.extend(p.prototype, {
        parse: function(o, t, e, n) {
            ...
            var a = this
              , r = u.type(o)
              , i = this._rgba = [];
            return t !== l && (o = [o, t, e, n],
            r = "array"),
            "string" === r ? this.parse(k(o) || f._default) : "array" === r ? (b(h.rgba.props, function(t, e) {
                i[e.idx] = _(o[e.idx], e)
            }),
            ...
            : function(t, n) {
                ...
                a[r] && u.inArray(null, a[r].slice(0, 3)) < 0 && (a[r][3] = 1,
                n.from && (a._rgba = n.from(a[r])))
            }
            ),
            this) : void 0
        },
        is: function(t) {
            ...
            return b(h, function(t, e) {
                var n, r = o[e.cache];
                return r && (n = i[e.cache] || e.to && e.to(i._rgba) || [],
                b(e.props, function(t, e) {
                    if (null != r[e.idx])
                        return a = r[e.idx] === n[e.idx]
                })),
                a
            }),
            a
        ...
        transition: function(t, i) {
            ...
            return b(n.props, function(t, e) {
                var n = e.idx
                  ...
                  , o = c[n]
                  , a = g[e.type] || {};
                null !== o && (null === r ? f[n] = o : (a.mod && (a.mod / 2 < o - r ? r += a.mod : a.mod / 2 < r - o && (r -= a.mod)),
                f[n] = _((o - r) * i + r, e)))
            }),
            this[e](f)
        },
    ...
    b(h, function(f, t) {
        ...
        p.fn[f] = function(t) {
            ...
            t === l)
                return this[i].slice();
            var e, n = u.type(t), r = "array" === n || "object" === n ? t : arguments, o = this[i].slice();
        ...
        b(a, function(i, s) {
            p.fn[i] || (p.fn[i] = function(t) {
                var e, n = u.type(t), r = "alpha" === i ? this._hsla ? "hsla" : "rgba" : f, o = this[r](), a = o[s.idx];
                return "undefined" === n ? a : ("function" === n && (t = t.call(this, a),
                n = u.type(t)),
                null == t && s.empty ? this : ("string" === n && (e = d.exec(t)) && (t = a + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)),
                o[s.idx] = t,
                this[r](o)))
            }
            )
    ...
    p.hook = function(t) {
        ...
        b(t, function(t, a) {
            ...
            u.fx.step[a] = function(t) {
                t.colorInit || (t.start = p(t.elem, a),
                t.end = p(t.end),
                t.colorInit = !0),
    ...
    s.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(t, e) {
        s.fx.step[e] = function(t) {
            ("none" !== t.end && !t.setAttr || 1 === t.pos && !t.setAttr) && (w.style(t.elem, e, t.end),
            t.setAttr = !0)
        }
    }),
        ...
        return this.queue(function() {
            ...
            e = e.map(function() {
                ...
                this.diff = function(t, e) {
                    ...
                    for (n in e)
                        r = e[n],
                        t[n] !== r && (y[n] || !s.fx.step[n] && isNaN(parseFloat(r)) || (o[n] = r));
                    return o
                }(this.start, this.end),
                this
            }),
    ...
    s.fn.extend({
        ...
        removeClass: (o = s.fn.removeClass,
        function(t, e, n, r) {
        ...
        toggleClass: (a = s.fn.toggleClass,
        function(t, e, n, r, o) {
    ...
    s.extend(s.effects, {
        ...
        restore: function(t, e) {
            for (var n, r = 0; r < e.length; r++)
                null !== e[r] && (void 0 === (n = t.data(C + e[r])) && (n = ""),
                t.css(e[r], n))
        },
